...
async def generate(state: GraphState, config: RunnableConfig):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system",
            ...
            "Do NOT describe what you are doing, do NOT explain your reasoning process. Start your answer directly. "
            "Answer ONLY what the question asks. Do NOT include adjacent or related controls, policies, or clauses that were not asked about. "
            "Be concise. Quote at most ONE short passage verbatim using a block quote (>) — only when the exact wording matters — then explain it in plain language. Prefer a direct plain-language answer over long quotations. "
            "If the user requests a specific format (bullet points, numbered list, detailed explanation), follow it. "
