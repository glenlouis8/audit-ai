...
async def generate(state: GraphState, config: RunnableConfig):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system",
            ...
            "Quote the most relevant text verbatim using block quotes (>), then explain what it means in plain language. "
            "If multiple passages are relevant, quote each one and explain each. "
